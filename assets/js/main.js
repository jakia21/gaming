...
var $car = $('.how-wrapper').find('.plane');
var $smoke = $('.how-wrapper').find('.carsmoke');


$(window).on('load resize scroll', function() {
  clearTimeout($car.t);
  $('.how-wrapper').each(function() {
...
"maxRadius": 100,
  ...
  "valueText": "[[value]] BNB"},
      ...
      "dataProvider": [
          {
              "category": "PCS Liquidity",
              "column-1": "1495"
          },
          {
              "category": "Development, Marketing & Team",
              "column-1": "789"
          },
          {
              "category": "DxSale Fee",
